...
<div class="container-fluid" style="background-color: aliceblue;">
  <div class="row">
    ...
    <img class="center-block img-responsive img-rounded" src="images/bcesb.jpg" alt="ssssss" >
	  <br>
	<br>
	  <h1 class="text-center text-primary">Department of Civil engineering</h1>
</div>
...
<div class="row">
      ...
      <div class="">
        ...
        <h3><strong> </strong></h3>
  <p>
Civil engineering is a professional engineering discipline that deals with the design, construction, and maintenance of the physical and naturally built environment (civilization), including works like roads, bridges, canals, dams, airports, sewerage systems, pipelines, and railways. Civil engineering is traditionally broken into a number of sub-disciplines. It is the second-oldest engineering discipline after military engineering,and it is defined to distinguish non-military engineering from military engineering. Civil engineering takes place in the public sector from municipal through to national governments, and in the private sector from individual homeowners through to international companies. </p>
...
<div class="row">
    <div class="col-md-4">
      <div class="">
       <img class="center-block img-responsive img-rounded" src="images/imagel.png">
		  <section  style="text-align: center; padding:inherit;">
		  	<h4><strong>Mr.Lokesh Malviya</strong></h4>
      ...
      <div class="col-md-7">
      <div class="">
        <h3><strong>Mr.Lokesh Malviya</strong></h3>
		  <br>
