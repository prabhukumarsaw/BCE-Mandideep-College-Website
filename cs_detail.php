...
<div class="container-fluid" style="background-color: aliceblue;">
  <div class="row">
    ...
    <img class="center-block img-responsive img-rounded" src="images/bcesb.jpg" alt="ssssss" >
	  <br>
	<br>
	  <h1 class="text-center text-primary">Department of Computer Science</h1>
</div>
...
<div class="row">
      ...
      <div class="">
        ...
        <h3><strong> </strong></h3>
  <p>
Bansal college of engineering recoginise a key rule that IT plays in teaching as well research. Therefore,IT is committed to provide computing facilities of highest standards. A high speed optical fiber netwoks of 12 Mbps with wireless redundency allows all students to access a range os services accross our entire campus including all computer labs and common rooms.</p>
        </div>
  </div>
...
<div class="row">
    <div class="col-md-4">
      <div class="">
       <img class="center-block img-responsive img-rounded" src="images/imagel.png">
		  <section  style="text-align: center; padding:inherit;">
		  	<h4><strong>Mr.Rishikesh Rawat</strong></h4>
      ...
      <div class="col-md-7">
      <div class="">
        <h3><strong>Prof. Rawat sir</strong></h3>
		  <br>
